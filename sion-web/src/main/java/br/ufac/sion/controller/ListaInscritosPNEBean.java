...
public class ListaInscritosPNEBean implements Serializable {
    ...
    private List<Inscricao> inscritosPNE;
    
    @PostConstruct
    public void inicializar() {
        this.inscritosPNE = inscricaoFacade.findByConcursoAndPNE(concurso);
    }

    public ListaInscritosPNEBean() {
        inscritosPNE = new ArrayList<>();
        recuperaConcursoSessao();
    }

    public List<Inscricao> getInscritosPNE() {
        return inscritosPNE;
    }
